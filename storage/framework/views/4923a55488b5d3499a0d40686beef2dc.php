<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        <a href="/" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="me-2"></i>SemsarNet</h3>
        </a>
        <div class="d-flex align-items-center ms-4 mb-4">
            ...
            <div class="ms-3">
                <h6 class="mb-0">Abdelilah Tainit</h6>
                <span>Admin</span>
            </div>
        </div>
        <div class="navbar-nav w-100">
            ...
            <a href="" class="nav-item nav-link <?php echo $__env->yieldContent('com'); ?> mb-3"><i
                    class="bi bi-emoji-smile me-2"></i>commontaires</a>

        </div>
    </nav>
</div>
<?php /**PATH C:\Users\abdel_mgur99m\Desktop\gestion immobilier\projet\backend\resources\views/layout/siadBar.blade.php ENDPATH**/ ?>