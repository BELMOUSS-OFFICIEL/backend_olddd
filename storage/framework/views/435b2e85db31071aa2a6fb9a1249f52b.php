...
<?php endif; ?>
          ...
          <div class="text-end m-4">
            <a class="btn btn-outline-primary active" href="<?php echo e(route('immobiliers.index')); ?>">Desponibles</a>
            <a class="btn btn-outline-primary" href="<?php echo e(route('immobiliersEncours.index')); ?>">En cours</a>
          </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\MY_OMAR_PROJET_FINAL\backend\resources\views/pages/immobiliers/index.blade.php ENDPATH**/ ?>