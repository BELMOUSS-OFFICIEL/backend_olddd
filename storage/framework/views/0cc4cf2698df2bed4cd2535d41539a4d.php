    ...
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                <i class="bi bi-alarm fs-2 text-primary"></i>
                <div class="ms-2">
                    <p class="mb-2">Total Immobilieres</p>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                <i class="bi bi-alarm fs-2 text-primary"></i>
                <div class="ms-2">
                    <p class="mb-2">Total commontaires</p>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abdel_mgur99m\Desktop\gestion immobilier\projet\backend\resources\views/index.blade.php ENDPATH**/ ?>