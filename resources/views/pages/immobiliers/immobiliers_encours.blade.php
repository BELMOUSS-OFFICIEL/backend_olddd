...
@endif
            ...
            <div class="tab-content px-5">
              ...
              <div class="text-end m-4">
                <a class="btn btn-outline-primary " href="{{route('immobiliers.index')}}">Desponibles</a>
                <a class="btn btn-outline-primary active" href="{{route('immobiliersEncours.index')}}">En cours</a>
              </div>
              <hr class=" bg-dark fw-bold">

                <div class="row ">

                    @foreach ($immobilierEnCours as $immobiliere)
